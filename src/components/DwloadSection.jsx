    ...
    return (
        ...
        <div id="download" className="dw-section">
            ...
            <ul>
                ...
                <li>
                    <a href = "https://drive.google.com/uc?export=download&id=1nC0jE46M0Hghjp-eHAOd_CoYW6Nv83-J" download className="download windows">
                ...
                <li>
                    <a href = "https://drive.google.com/uc?export=download&id=1nC0jE46M0Hghjp-eHAOd_CoYW6Nv83-J" download className="download apple">
